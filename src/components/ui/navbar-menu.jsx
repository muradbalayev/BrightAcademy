            ...
            <div
              ...
              <motion.div
                ...
                <motion.div
                  ...
                  layout
                  className="w-max h-full lg:p-4 p-2">
                  {children}
                </motion.div>
              </motion.div>
            </div>
...
export const ProductItem = ({
  ...
  return (
    (<Link to={href} className="flex items-center gap-3 lg:min-h-[160px] hover:bg-gray-200 dark:hover:bg-neutral-800 p-4 rounded-xl">
